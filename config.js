module.exports = {
  ...
  SUPPORT_SERVER: "https://discord.gg/GChFJJSsry", // Your bot support server
  PRESENCE: {
  ...
  INTERACTIONS: {
    ...
    TEST_GUILD_ID: "992769438380216332", // Guild ID where the interactions should be registered. [** Test you commands here first **]
  },
  XP_SYSTEM: {
